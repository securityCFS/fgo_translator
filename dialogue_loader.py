    ...
    def list_latest_tasks(self, region: str = "JP", limit: int = 50) -> List[Dict]:
        ...
        def normalize_quest(quest, spot, war, task=None, map_by_id=None):
            ...
            return {
                ...
                "afterClear": quest.get("afterClear", ""),
                ...
                "spotImage": spot.get("image", ""),
                "questOfsX": spot.get("questOfsX"),
                "questOfsY": spot.get("questOfsY"),
                "nameOfsX": spot.get("nameOfsX"),
                "nameOfsY": spot.get("nameOfsY"),
                "mapId": map_id,
